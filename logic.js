...
function time_fun() {
	...
	setInterval(function () {
		...
		document.getElementById("timeCount").innerText = two_char(m) + ":" + two_char(s);
	}, 1000);
}
...
function refer(){
	if(time==0){
		window.location.href="gameEnd.php?score="+document.getElementById("score").innerText;
	}
	time--;
}

function leaderBoard(){
	window.location.href = "leader_board.php";
}
...
function newGame() {
	var span = document.getElementById("score_part");
	span.innerHTML = "<p>Your score: <span id='score'>0</span></p>";
	var timer = document.getElementById("timer");
	timer.innerHTML = "<h1 id='timeCount'>00:00</h1>";
